...
import { Card, Group, useMantineTheme, Button, createStyles } from '@mantine/core';
...
function MateriaStudent() {
  ...
  return (
    <>
      ...
      <Card className={classes.containerCard} w="100%" h="100%" style={{ borderRadius: '15px 0 0 15px' }}>
